...
public class Professor implements Serializable{
	...
	private transient List<SerieEspecificada> series = new ArrayList<>();
	...
	public List<SerieEspecificada> getSeries() {
		return series;
	}

	public void setSeries(List<SerieEspecificada> series) {
		this.series = series;
	}
